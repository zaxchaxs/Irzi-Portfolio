...
export default function AboutPage() {
    return(
        <div className="w-full mx-auto px-10 sm:px-24 md:flex overflow-hidden" >
            <div className="w-full border-2 border-black flex justify-between">
                ...
                <div className="pt-20 p-10 border-2 border-green-500 w-full">
                    <div className="border-2 border-black p-4">
                        <motion.h1
                            className={`text-xl sm:text-2xl text-black ${lexendDeca.className} `}
                    ...
                    <div className="border-2 border-red-500 w-full p-2 text-gray-700 ">
                        <motion.h1
                            className={`font-bold text-2xl p-2 tracking-widest`}
                            initial={{x: -100, opacity: 0}}
                            whileInView={{x: 0, opacity: 1}}
                        ...
                        <motion.p
                            className={`text-xl text-justify indent-8`}
                            initial={{x: -100, opacity: 0}}
                            whileInView={{x: 0, opacity: 1}}
