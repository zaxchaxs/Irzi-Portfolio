    ...
    return(
            <div className='p-10 sm:p-24 mx-auto pt-20 md:flex justify-between overflow-hidden'>
                ...
                <div className='p-4 sm:p-2 w-full border-2 border-black'>
                    ...
                    <div className={`md:text-left mx-auto w-full text-center m-4 md:block sm:mt-7 border-2 border-black text-black font-bold ${rowdies.className}`}>
                        <motion.h1
                    ...
                    <motion.div 
                        className='text-base text-center sm:text-left sm:text-xl text-gray-600 tracking-widest pt-2'
                        initial={{ x: -100, opacity: 0 }}
                        whileInView={{ x: 0, opacity: 1 }}
                    ...
                    >
                        ...
                        <div className='p-2 sm:p-4 flex justify-center items-center sm:block'>
                            <HomeButton value="Download CV" background={"bg-gray-600"} textCol={"text-white"} bgHover={"bg-white"} textHov={"text-gray-600"} />
                            <HomeButton value="Contact Me" background='bg-white' textCol="text-gray-600" bgHover={"bg-gray-600"} textHov={"text-white"} />
                        </div>
                    </motion.div>
                </div>
                <motion.div
